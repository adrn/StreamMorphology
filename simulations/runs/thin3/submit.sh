...
cd /vega/astro/users/amp2217/projects/morphology/simulations/runs/thin3
make
./scf
/vega/astro/users/amp2217/projects/streamteam/bin/moviesnap --path=/vega/astro/users/amp2217/projects/morphology/simulations/runs/thin3
